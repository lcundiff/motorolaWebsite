...
(function () {
  describe('ApplicantsAdminsController', function () {
    // Initialize global variables
    var scope,
      ApplicantsAdminsController,
      $state,
      Authentication;
    ...
    beforeEach(inject(function ($controller, $rootScope, _$state_, _Authentication_) {
      ...
      ApplicantsAdminsController = $controller('ApplicantsAdminsController as vm', {
        $scope: scope
      });
    }));

    describe('listActiveStudents', function () {
      it('listActiveStudents should list active students', function () {
        console.log(ApplicantsAdminsController);
      });
    });

    describe('listDeactivatedStudents', function () {
      it('listDeactivatedStudents should list inactive students', function () {
      });
    });
